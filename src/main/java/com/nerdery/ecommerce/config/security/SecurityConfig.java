...
public class SecurityConfig {
    ...
    private static void buildRequestMatchers(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry authReqConfig) {
        ...
        authReqConfig.requestMatchers(HttpMethod.POST, "/reset-password/request").permitAll();
        authReqConfig.requestMatchers("/graphqli", "/graphql/**").permitAll();
        authReqConfig.requestMatchers(HttpMethod.POST,"/products/**").permitAll();
        authReqConfig.requestMatchers(HttpMethod.POST,"/checkout/**").permitAll();
        authReqConfig.requestMatchers(HttpMethod.POST,"/webhook/stripe").permitAll();
        authReqConfig.requestMatchers(HttpMethod.POST,"/create-payment-intent").permitAll();
